        ...
        return UserResponse.builder()
                ...
                .connectedAccounts(
                    user.getConnectedAccounts().stream()
                        .map(ConnectedAccountResponse::from)
                        .toList()
                )
    ...
    public static class ConnectedAccountResponse {
        ...
        public static ConnectedAccountResponse from(ConnectedAccount ca) {
            return ConnectedAccountResponse.builder()
                    .id(ca.getId())
                    .platform(ca.getPlatform().name().toLowerCase())
                    .platformUserId(ca.getPlatformUserId())
                    .platformUsername(ca.getPlatformUsername())
                    .platformDisplayName(ca.getPlatformDisplayName())
                    .avatarUrl(ca.getAvatarUrl())
                    .accessTokenExpiresAt(ca.getAccessTokenExpiresAt())
                    .connectedAt(ca.getConnectedAt())
                    .active(ca.isActive())
                    .build();
        }
    }
